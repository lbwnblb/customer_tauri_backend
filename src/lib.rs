...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![commands::greet::greet, commands::shop::shop_account, commands::shop::add_shop, commands::shop::delete_shop, commands::shop::shop_list, commands::shop::select_shop, commands::platform::select_platform, commands::index_channel::start_backend_channel, commands::shop_channel::add_shop_channel])
        .setup(|app| {
